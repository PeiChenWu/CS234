...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        """
        ##############################################################
        ################ YOUR CODE HERE - 3-4 lines Pei-Chen ################## 

        if t <= self.nsteps:
            #v = np.linspace(self.eps_end, self.eps_begin, self.nsteps+1)
            #print(v[t])
            #self.epsilon = v[t]
            #print(self.eps_begin + float(float(self.eps_end - self.eps_begin)/self.nsteps) * t)
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        """
        ##############################################################
        ################ YOUR CODE HERE - 4-5 lines Pei-Chen ##################
